    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F4E8E1] to-[#CEC1B8]">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-[#3B3632] mb-2">Terms of Service</h1>
        ...
        <div className="bg-[#F9F6F3] rounded-2xl shadow-lg p-8 space-y-6 text-[#3B3632]">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">3. User Accounts</h2>
            <p className="text-[#6B6560] leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">4. Subscription Tiers and Payment</h2>
            <p className="text-[#6B6560] leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">5. Refund Policy</h2>
            <p className="text-[#6B6560] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">7. Intellectual Property</h2>
            <p className="text-[#6B6560] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">8. Disclaimer of Warranties</h2>
            <p className="text-[#6B6560] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">9. Limitation of Liability</h2>
            <p className="text-[#6B6560] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">10. Changes to Terms</h2>
            <p className="text-[#6B6560] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">11. Contact Information</h2>
            <p className="text-[#6B6560] leading-relaxed">

...
const PrivacyPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F4E8E1] to-[#CEC1B8]">
      <div className="max-w-4xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <Link 
            to="/login" 
            className="inline-flex items-center text-[#8B7E74] hover:text-[#5A524A] transition-colors mb-4"
          >
            <ArrowLeft className="w-4 h-4 mr-2" />
            Back to Login
          </Link>
          <h1 className="text-4xl font-bold text-[#3B3632] mb-2">Privacy Policy</h1>
          <p className="text-[#8B7E74]">Last Updated: December 8, 2025</p>
        </div>

        {/* Content */}
        <div className="bg-[#F9F6F3] rounded-2xl shadow-lg p-8 space-y-6 text-[#3B3632]">
          
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">2. Information We Collect</h2>
            
            <h3 className="text-xl font-semibold mb-3 text-[#5A524A] mt-4">2.1 Information You Provide</h3>
            <ul className="list-disc list-inside text-[#6B6560] space-y-2 ml-4">
            ...
            <h3 className="text-xl font-semibold mb-3 text-[#5A524A] mt-4">2.2 Automatically Collected Information</h3>
            <ul className="list-disc list-inside text-[#6B6560] space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">4. Data Storage and Security</h2>
            <p className="text-[#6B6560] leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">5. Data Sharing and Disclosure</h2>
            <p className="text-[#6B6560] leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">6. Data Retention</h2>
            <p className="text-[#6B6560] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">7. Your Rights and Choices</h2>
            <p className="text-[#6B6560] leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">8. Children's Privacy</h2>
            <p className="text-[#6B6560] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">9. International Data Transfers</h2>
            <p className="text-[#6B6560] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">10. Changes to This Privacy Policy</h2>
            <p className="text-[#6B6560] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-[#5A524A]">11. Contact Us</h2>
            <p className="text-[#6B6560] leading-relaxed">
        ...
        {/* Footer */}
        <div className="mt-8 text-center text-[#8B7E74] text-sm">
          <p>

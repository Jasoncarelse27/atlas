-- Atlas Database Partitioning Migration (FIXED)
...
-- FIXED: Primary key constraint issue resolved
...
BEGIN
    ...
    IF messages_count > 0 THEN
        ...
        SELECT id, conversation_id, user_id, role, content, created_at, updated_at
        FROM messages 
...
VALUES (
    ...
    jsonb_build_object(
        'migration', '20250110_database_partitioning_fixed',
...
BEGIN
    ...
    RAISE NOTICE '🔑 FIXED: Primary key constraint issue resolved';
END $$;

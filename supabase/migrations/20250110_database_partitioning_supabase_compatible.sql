-- Atlas Database Partitioning Migration (Supabase Compatible)
...
-- Compatible with Supabase (no external extensions required)
...
-- Create partitioned usage_logs table
...
VALUES (
    ...
    jsonb_build_object(
        'migration', '20250110_database_partitioning_supabase_compatible',
